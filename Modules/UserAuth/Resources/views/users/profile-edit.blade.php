    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b">
                ...
                <!--begin::Form-->
                <form class="form" id="user_edit_form" action="{{ url('/userauth/users/profile-update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-footer text-right">
                        <button type="submit" id="edit_user_submit_btn" class="btn btn-primary font-weight-bold mr-2">
                            <i class="la la-save"></i>Save Profile
                        </button>
...
@section('custom-js-section')
    ...
    <script>
        jQuery(document).ready(function() {
            UsersCustomJsBlocks.editProfilePage('{{ url('/') }}');
        });
    </script>
