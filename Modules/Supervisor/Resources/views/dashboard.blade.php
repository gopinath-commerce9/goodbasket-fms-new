                                ...
                                <form name="filter_supervisor_order_form" id="filter_supervisor_order_form" action="{{ url('/supervisor/filter-order') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 text-right">
                                            <button type="button" id="filter_supervisor_order_filter_btn" class="btn btn-primary btn-lg mr-2">Filter</button>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive text-center" id="supervisor_order_filter_table_area">
                                    <table class="table table-bordered" id="supervisor_order_filter_table">
                                        ...
                                        <?php foreach($supervisorOrders as $record)
                                        {
                                            ...
                                            $viewLink = url('/supervisor/order-view/' . $orderId);
                                            if ($deliveryPickerData && (count($deliveryPickerData) > 0)) {
                                                ...
                                                if ($pickerDetail->actionDoer) {
                                                    $deliveryPicker = $pickerDetail->actionDoer->name;
                                                }
                                            }
                                            if ($deliveryDriverData && (count($deliveryDriverData) > 0)) {
                                                ...
                                                if ($driverDetail->actionDoer) {
                                                    $deliveryDriver = $driverDetail->actionDoer->name;
                                                }
                                            }
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $deliveryDate }}</td>
                                            <td>{{ $deliverySlot }}</td>
                                            <td>{{ $deliveryPicker }}</td>
                                            <td>{{ $deliveryPickerTime }}</td>
                                            <td>{{ $deliveryDriver }}</td>
