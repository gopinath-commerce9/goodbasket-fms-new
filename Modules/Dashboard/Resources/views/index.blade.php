                ...
                <div class="wizard-nav">
                    <div class="wizard-steps">
                        ...
                        <div class="wizard-step" data-wizard-type="step" <?php if($selectedEmirate=='DXB'){?> data-wizard-state="current" <?php } ?>>
                            <a class="wizard-label" href="{{ url('/dashboard') }}?emirate=DXB">
                        ...
                        <div class="wizard-step" data-wizard-type="step" <?php if($selectedEmirate=='SHJ'){?> data-wizard-state="current" <?php } ?>>
                            <a class="wizard-label" href="{{ url('/dashboard') }}?emirate=SHJ">
                                <h3 class="wizard-title">
                                    Sharjah
                                </h3>
                                <div class="wizard-bar"></div>
                        ...
                        <div class="wizard-step" data-wizard-type="step" <?php if($selectedEmirate=='AJM'){?> data-wizard-state="current" <?php } ?>>
                            <a class="wizard-label" href="{{ url('/dashboard') }}?emirate=AJM">
                                <h3 class="wizard-title">
                                    Ajman
                                </h3>
                                <div class="wizard-bar"></div>
                        ...
                        <div class="wizard-step" data-wizard-type="step" <?php if($selectedEmirate=='AUH'){?> data-wizard-state="current" <?php } ?>>
                            <a class="wizard-label" href="{{ url('/dashboard') }}?emirate=AUH">
                                <h3 class="wizard-title">
                                    Abu Dhabi
                                </h3>
                                <div class="wizard-bar"></div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/dashboard/delivery-details') }}?region=<?php echo urlencode($selectedEmirate);?>&interval=<?php echo urlencode($record['delivery_time_slot']);?>&date=<?php echo urlencode($record['delivery_date']);?>">
                ...
                <div class="card card-custom">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td><?php echo $i?></td>
                                <td><a href="{{ url('/dashboard/driver-details') }}?sn=<?php echo urlencode($i);?>&date=<?php echo urlencode($todayDate);?>&driver=<?php echo urlencode($data['wing_order_driver']);?>&count=<?php echo urlencode($data['count_of_orders']);?>"> <?php echo $data['wing_order_driver']?> </a></td>
